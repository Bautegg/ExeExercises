...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if(x < 0.9 * threshold):
        return 'LOW'
    elif(abs(x - threshold) <= (0.1 *threshold)  ):
        return 'NORMAL'
    else:
        return 'DANGER'
...
if __name__ == '__main__':
    ...
    print(f'Is critically balanced: {is_criticality_balanced(200, 1000)}')
    print(f'band color: {reactor_efficiency(50, 50, 15000)}')
    print(f'STATUS: {fail_safe(100, 89, 10000)}')
